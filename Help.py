...
class HelpCommand(sublime_plugin.WindowCommand):
	...
	def __init__(self,*args,**kwargs):
		...
		defaultSettings={'PHP':'http://php.net/%s','MooTools':'http://mootools.net/search?q=%s','jQuery':'http://api.jquery.com/?s=%s','Google':'http://google.com/#newwindow=1&q=%s','Yandex':'http://yandex.ru/yandsearch?text=%s'}
